(function () {
  const lanes = {
    ...
    analysis: "Scene analysis and assembly",
    festival: "Festival entry",
    viewing: "Viewing and follow-up",
  ...
  const builders = [
    ...
    builder({
      ...
      heading: "Capture a proper viewing only once there is a watchable cut or completed film.",
      lane: lanes.viewing,
    ...
    builder({
      ...
      page: "runsheet.html",
      label: "Run Sheet",
      title: "Film assembly run sheet builder",
      heading: "Compile scenes into a working film order.",
      lane: lanes.analysis,
      ...
      fields: [
        select("status", "Status", statusOptions(), "draft for human review"),
        select("visibility", "Public/private posture", visibilityOptions(), "private working note"),
        text("assemblyTitle", "Assembly title"),
        text("filmTitle", "Film title"),
        text("cutVersion", "Cut / assembly version", "Rough assembly, first cut, fine cut, festival cut, short cut."),
        date("assemblyDate", "Assembly date"),
        text("editorLead", "Editor / lead"),
        area("filmClaim", "Film claim or spine"),
        area("sceneOrder", "Scene order", "One per line. Include scene label, rough timestamp or intended position."),
        area("evidenceBeats", "Evidence beats", "What each scene proves, complicates or sets up."),
        area("transitions", "Transitions and rhythm", "What connects the scenes: contrast, chronology, theme, place, voice, silence, music or archive."),
        area("gaps", "Gaps, missing shots or weak joins"),
        area("pickups", "Pickups, inserts or source checks needed"),
        area("cuts", "Scenes to cut, shorten or move"),
        area("publicPrivatePause", "Private or sensitive material to protect", "People, places, permissions, unfinished allegations or rough-cut notes not for public use."),
        area("nextAction", "Next useful action")
      ],
      sections: [
        sec("Assembly", ["assemblyTitle", "filmTitle", "cutVersion", "assemblyDate", "editorLead"]),
        sec("Film Claim Or Spine", "filmClaim"),
        list("Scene Order", "sceneOrder"),
        list("Evidence Beats", "evidenceBeats"),
        list("Transitions And Rhythm", "transitions"),
        list("Gaps, Missing Shots Or Weak Joins", "gaps"),
        list("Pickups, Inserts Or Source Checks Needed", "pickups"),
        list("Scenes To Cut, Shorten Or Move", "cuts"),
        sec("Private Or Sensitive Material To Protect", "publicPrivatePause"),
        sec("Next Useful Action", "nextAction")
      ],
      reviewQuestions: [
        "Does the order make the film claim clearer?",
        "Which scene carries each evidence beat?",
        "Where does the film drag, jump or over-explain?",
        "What is missing before this cut can be shown?",
        "What should stay private while the film is still being compiled?"
      ]
    }),
    builder({
      key: "event-notes",
  ...
  function labelFor(id) {
    const labels = {
      ...
      cutVersion: "Cut / assembly version",
      assemblyDate: "Assembly date",
      editorLead: "Editor / lead",
      host: "Host",
      audience: "Audience",
