...
- `assets/css/site.css` - layout, forms, responsive behaviour and print-safe basics.
- `assets/js/builder-data.js` - all builder definitions and Markdown renderers.
- `assets/js/builder-page.js` - shared form, preview, copy, download and reset behaviour.
